...
function AdminSideNav() {
  ...
  return (
    ...
    <ul className="mt-4  flex-col ">
        ...
        <li className="mb-1 group">
            <a onClick={()=>{navigate('/admin/contact')}}  className="flex font-semibold items-center gap-1  py-3 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
            <ClipboardList  strokeWidth={1.5} size={16} />
